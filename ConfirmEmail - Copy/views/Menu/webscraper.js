    ...
    return new Promise((resolve, reject) => {
        ...
        xmlHttp.onreadystatechange = function() {
            if (xmlHttp.readyState === 4 && xmlHttp.status === 200) {
                ...
                resolve({
                    soup: GetSoup() || "Soup Not Available",
                    salad: GetSalad() || "Salad Not Available",
                    entree: GetEntree() || "Entree Not Available",
                    specialdietentree: GetSpecialDietEntree() || "Diet Entree Not Available",
                    sides: GetSides() || "Sides Not Available",
                    dessert: GetDessert() || "Dessert Not Available"
                });
            }
        };
